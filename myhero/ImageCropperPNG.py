...
pyautogui.moveTo(currentMouseX, currentMouseX)
pyautogui.click()
...
class ImageCropper:
    ...
    def __init__(self):
        ...
        self.canvas = Tkinter.Canvas(self.root, 
                             ...
                             bd = 0)
        self.DirCropped = '/tmp/tmp_graph/'
        self.filename= 'myhero4'#self.files.split('/')[1]
    ...
    def set_directory(self, directory):
        ...
        for filename in files:
            if filename[-11:] == self.DirCropped + self.filename +'_Graph.png':
    ...
    def __on_mouse_move(self, event):
        self.box[2], self.box[3] = event.x, event.y #self.__fix_ratio_point(event.x, event.y)
